...
const faqs = [
  {
    ...
    answer:
      "Yes. All 45 tools on OpticShift Pro are completely free with no hidden charges, no subscriptions, and no sign-up required. You can use every tool as many times as you need.",
  },
  {
