      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-lg">
            Reduce PNG file size by up to 80% by converting to JPG format instantly in your browser.
          </p>
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-base leading-relaxed">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Images with transparency:</strong> JPG does not support transparent backgrounds. If your PNG has a transparent layer (like a logo on a clear background), converting to JPG will fill the transparent area with a solid color, usually white.</li>
            <li><strong>Screenshots with text:</strong> PNG is better for screenshots because text and sharp edges remain crisp. JPG compression can cause blurring around text and fine lines.</li>
            <li><strong>Logos and icons:</strong> Keep logos and icons in PNG or SVG format for maximum sharpness at all sizes.</li>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>A 2MB PNG photograph can often become a 400KB JPG without visible quality loss</li>
            <li>A 5MB PNG screenshot may reduce to 800KB as a JPG</li>
          ...
          <div className="overflow-x-auto">
            <table className="w-full border border-border rounded-lg">
              ...
              <tbody>
                ...
                <tr className="border-b">
                  <td className="p-3">Photography / Print</td>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Re-compressing an already compressed JPG — each compression cycle reduces quality.</li>
            <li>Converting screenshots with text — JPG blurs sharp text edges.</li>
          ...
          <p>
            JPG uses lossy compression so some data is removed, but at 80–90% quality settings the difference is invisible to the human eye for photographs.
          </p>

          <h3 className="font-semibold mt-6">Will transparency be preserved when converting to JPG?</h3>
          <p>
            No. JPG does not support transparency. Transparent areas in your PNG will be filled with a solid background color (usually white) after conversion.
          </p>
          ...
          <div className="mt-10">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <Link href="/blog/how-to-convert-jpg-to-png">JPG to PNG Conversion Guide</Link>
              </li>
              <li>
                <Link href="/blog/jpg-vs-png-vs-webp">JPG vs PNG vs WebP — Which Format to Use?</Link>
              </li>
              <li>
          ...
          <div className="mt-10 p-6 bg-primary/10 rounded-2xl text-center space-y-3">
            <p className="font-bold text-lg">Ready to convert your PNG files?</p>
            <Link
