...
export const metadata: Metadata = {
  ...
  keywords: ['heic to jpg', 'heic converter', 'convert heic to jpg', 'how to change heic to jpg', 'converting heic to jpg', 'heif to jpg', 'iphone photo converter', 'heic to jpeg online', 'free heic converter', 'heic to jpg no upload'],
  openGraph: {
