...
export const metadata: Metadata = {
  ...
  description: 'OpticShift Pro is an independently built suite of 44+ free image, PDF, and text tools that run entirely in your browser.',
};
    ...
    <div className="min-h-screen pt-32 pb-20 px-4">
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <section className="text-center py-10 px-6 bg-card/50 backdrop-blur-sm rounded-2xl border border-border">
          ...
          <p className="text-muted-foreground mb-6">Try any of our 44+ free tools — no account needed, no files uploaded.</p>
          <Link
            href="/tools"
