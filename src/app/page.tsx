      ...
      <section className="relative pt-20 md:pt-32 pb-12 md:pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center space-y-6 md:space-y-8">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium">
            ...
            <span>{TOOL_COUNT_LABEL} free, fast, online browser-based tools, zero uploads</span>
          </div>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold">See The Tool Before You Use It</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
              Real interface previews for each tool, so you know exactly what you&apos;re getting before clicking in.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="p-5 text-left">
                  ...
                  <span className="inline-block mt-3 text-xs font-semibold text-primary bg-primary/10 px-2.5 py-1 rounded-full">
                    {card.badge}
                  </span>
                </div>
              </div>
            ...
            {[
              {
                ...
                step: '01',
                title: 'Choose a Tool',
                description: `Pick from ${TOOL_COUNT_LABEL} tools organized by category — image, PDF, or text.`,
              },
              {
                icon: Zap,
                step: '02',
