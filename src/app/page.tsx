...
export const metadata: Metadata = {
  ...
  description:
    'OpticShift Pro offers 45+ free online tools for image compression, format conversion, PDF editing, and text utilities — all processed instantly and privately in your browser. No uploads, no sign-up, no cost.',
};

const stats = [
  { label: 'Free tools', value: '45+' },
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="text-center">
            <Button size="lg" variant="outline" className="rounded-xl glass" asChild>
              <Link href="/tools">
                View All 48 Tools <ArrowRight className="ml-2" size={18} />
              </Link>
            </Button>
          </div>
        </div>
            ...
            {[
              {
                ...
                step: '01',
                title: 'Choose a Tool',
                description: 'Pick from 45+ tools organized by category — image, PDF, or text.',
              },
              {
                icon: Zap,
                step: '02',
          ...
          <div className="relative glass p-12 md:p-20 text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              <Button size="lg" className="h-14 px-10 rounded-xl text-lg shadow-xl shadow-primary/25" asChild>
                <Link href="/tools">
                  Explore All 45+ Tools <ArrowRight className="ml-2" size={18} />
                </Link>
              </Button>
