        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://cdn.jsdelivr.net *.google.com *.googlesyndication.com *.googletagmanager.com *.google-analytics.com *.doubleclick.net *.adtrafficquality.google",
              "style-src 'self' 'unsafe-inline' fonts.googleapis.com",
              "font-src 'self' fonts.gstatic.com",
              "img-src 'self' data: blob: *.google.com *.googlesyndication.com *.doubleclick.net *.gstatic.com *.adtrafficquality.google images.unsplash.com picsum.photos placehold.co",
              "media-src 'self' blob:",
              "worker-src 'self' blob:",
              "connect-src 'self' blob: https://cdn.jsdelivr.net *.google.com *.googlesyndication.com *.google-analytics.com *.doubleclick.net *.adtrafficquality.google *.googletagmanager.com",
